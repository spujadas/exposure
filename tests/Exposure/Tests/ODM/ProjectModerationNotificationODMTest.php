...
class ProjectModerationNotificationODMTest extends \PHPUnit_Framework_TestCase {
    protected static $dm ;
    ...
    public function testFound() {
        $this->notification = ObjectDocumentMapper::getById(self::$dm, 
            'Exposure\Model\ProjectModerationNotification', self::$id);
        $this->assertNotNull($this->notification);
        $this->assertInstanceOf('Exposure\Model\ProjectModerationNotification', $this->notification);
    }
